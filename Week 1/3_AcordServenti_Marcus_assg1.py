...
# The below functions print out the arrows and the second set of names in the specified formats, per the postcondition
print(arrows + firstName + " " + middleName + " " + lastName + "?")
print(arrows + firstName + " " + lastName + "?")
print(arrows + "Mr./Ms. " + firstName + " " + middleName + " " + lastName + "?")
print(arrows + "Dear " + firstName + "?")
...
# The below functions print out the arrows and the final set of names in the specified formats, per the postcondition
print(arrows + firstName + " " + middleName + " " + lastName + "?")
print(arrows + firstName + " " + lastName + "?")
print(arrows + "Mr./Ms. " + firstName + " " + middleName + " " + lastName + "?")
print(arrows + "Dear " + firstName + "?")
